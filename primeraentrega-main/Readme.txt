...
// se muestra todo si la categoria no es importante
  ...
  //  Si se debe  filtrar por categoria acá se hace el filtro gracias a dios por método filter me costo mucho encontrarlo
else {
...
Después para mostrar el producto llamamos al ItemDetail 
